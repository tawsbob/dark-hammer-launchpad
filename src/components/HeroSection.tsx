              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
                    ...
                    <div className="text-2xl font-bold text-white">{t('poweringThousands')} <span className="text-sm text-yellow-400">{t('projected')}</span></div>
                  </div>
                  ...
                  <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
                    ...
                    <div className="text-2xl font-bold text-white">{t('saveFullDay')} <span className="text-sm text-yellow-400">{t('projected')}</span></div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between p-3 bg-black/30 rounded-lg">
                        ...
                        <div className="text-sm font-semibold text-red-400">{channel.revenue}</div>
                      </div>
                    ))}
                  </div>
                </div>
